                ...
                <form action="{{route('roles.assign')}}" method="post">
                    ...
                    <div class="relative top-20 mx-auto p-5 w-96 shadow-xl rounded-md bg-white">
                        ...
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <button type="button" onclick="document.getElementById('role-assign-modal').classList.add('hidden')" class="text-gray-400 hover:text-gray-500">
                        ...
                        <div class="mb-6">
                            <label>User ID:</label>
                            <input type="text" class="modal-id-input outline-none" name="user_id" value="" readonly>
                            <div class="mt-4">
                                <p>Roles:</p>
                        ...
                        <div class="flex justify-end space-x-3">
                            <button type="button" onclick="document.getElementById('role-assign-modal').classList.add('hidden')" class="px-4 py-2 text-gray-600 hover:text-gray-800 font-medium rounded-lg border border-gray-300 hover:bg-gray-50 transition">
                                Cancel
                            </button>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            ...
                            <form action="{{route('users.delete', $user->id)}}" method="post">
                              @csrf
                              @method('delete')
                              <button type="submit" button class="text-red-600 hover:text-red-900">Delete</button>
                            </form>
                        </td>
                    </tr>
                    @endforeach
