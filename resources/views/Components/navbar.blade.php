        ...
        <div class="max-w-6xl mx-auto px-4">
            <div class="flex justify-between">
                <div class="flex space-x-7">
                    ...
                    @auth
                    <div class="hidden md:flex items-center space-x-1">
                        <a href="{{route('posts-readers')}}" class="py-4 px-2 text-blue-600  font-semibold">Posts</a>
                    </div>
                    @endauth
                ...
                <div class="hidden md:flex items-center space-x-3">
                    ...
                    @auth
                        <form action="{{route('logout')}}" method="post">
                            @csrf
                            <button type="submit" class="py-2 px-2 font-medium text-white bg-blue-600 rounded hover:bg-blue-700 transition duration-300 cursor-pointer">Logout</button>
                        </form>
                    @endauth
                </div>
                <!-- Mobile menu button -->
